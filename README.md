...
See `tools/README.md`, `outputs/rh_proof_route.md`, `outputs/rh_smoothed_convergence.md`, `outputs/rh_residue_match.md`, `outputs/rh_residue_subtraction.md`, `outputs/rh_contour_remainder.md`, `outputs/rh_dyadic_cancellation_target.md`, `outputs/rh_dyadic_t_scan.md`, `outputs/rh_dyadic_t_refinement.md`, `outputs/rh_dyadic_large_values.md`, `outputs/rh_dyadic_smoothness.md`, and `outputs/rh_dyadic_moments.md` for the full route.
