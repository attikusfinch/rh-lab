...
- Liouville sign comparison on product support versus full intervals
- Null-model tests for product-support Liouville cancellation
- GCD-stratified product-support cancellation checks
